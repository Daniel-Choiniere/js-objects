var fruitTwo = {apples: 35, 
				...
				grapes: 110,
 				...
 				totalFruit: function() {
					...
					return "There are " + allTheFruits + " total fruit items in stock."
				},
				...
				fruitSold: function(num) {
					var soldFruit = (this.apples + this.oranges + this.grapes)
					if ((soldFruit - num) < 30) {
						return "There are now " + ((this.apples + this.oranges + this.grapes) - num) + " fruit items in stock. We will run out of food to sell soon if order is not placed!!"
					} else {
						return "There are now " + ((this.apples + this.oranges + this.grapes) - num) + " fruits items stock. Please complete inventory again in three days.";
					}
				}
...
console.log(fruitTwo.fruitSold(140));
